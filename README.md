...
Set `JWT_EXPIRE=30d` in the deployed backend environment so authenticated sessions survive up to thirty days. A deliberate sign out still clears the browser session immediately.
